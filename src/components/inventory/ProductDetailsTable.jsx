...
const ProductDetailsTable = ({ onAddNew }) => {
  ...
  const handleDelete = async () => {
    ...
    // Proceed to delete selected products (snackbar will confirm)
    await dispatch(deleteProducts(selectedProducts));
    showNotification({
      message: `${selectedProducts.length} product(s) deleted`,
      severity: "success",
    });
  };
              ...
              >
                <td className="px-4 py-4">
                  <input
                    ...
                    onChange={() =>
                      handleSelectProduct(product.id || product._id)
                    }
                    className="w-4 h-4 text-orange-500 rounded focus:ring-orange-500"
                  />
                </td>
                ...
                <td className="px-4 py-4 text-sm text-gray-600">
                  {product.totalValue?.toLocaleString()} RWF
                </td>
                <td className="px-4 py-4">
