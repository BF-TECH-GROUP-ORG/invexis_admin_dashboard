 ...
 */
const getApiBase = () => {
  let url = process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_API_URL_SW || "http://localhost:8000";
...
const AnalyticsService = {
   ...
   */
  getPlatformHealth: (filters) => AnalyticsService.getReport('platform/health', filters),
   ...
   * Chart: Pie Chart
   */
  getCompanyStatus: (filters) => AnalyticsService.getReport('companies/status', filters),
   ...
   * Chart: Donut Chart
   */
  getTierDistribution: (filters) => AnalyticsService.getReport('companies/tiers', filters),
   ...
   * Chart: Horizontal Bar Chart
   */
  getTopCompanies: (filters) => AnalyticsService.getReport('sales/top-companies', filters),
   ...
   */
  getCompanyGrowth: (filters) => AnalyticsService.getReport('companies/growth', filters),
   ...
   */
  getPlatformRevenue: (filters) => AnalyticsService.getReport('platform/revenue', filters),
   ...
   */
  getPlatformUserActivity: (filters) => AnalyticsService.getReport('platform/user-activity', filters),
   ...
   */
  getServiceMetrics: (filters) => AnalyticsService.getReport('platform/service-metrics', filters),
